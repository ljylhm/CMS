...
export default function (accept) {
        ...
        this.getFile(function (file) {
            ...
            reader.onload = function (ev) {
                ...
                callback && callback({
                    data: dataURL,
                    fileName: fn,
                    extName: fn.substring(fn.lastIndexOf('.') + 1).toLowerCase(),
    ...
    this.toBase64 = function (arg) {
        return base64.Base64.btoa(arg);
    };
    ...
    this.openLocalImg = function (callback) {
        this.openLocalFile(callback);
    }
